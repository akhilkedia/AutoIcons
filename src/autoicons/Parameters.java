...
public class Parameters {
	...
	public static String CONVERT_COMMAND = " -gravity center -resize 256x256 -extent 256x256 -transparent white -colors 16777216 \"" + DATA_PATH
			+ "icon256.png\"" + " && composite -gravity SouthEast foldericon.png \"" + DATA_PATH + "icon256.png\" \"" + DATA_PATH + "icon256.png\""
			+ " && convert \"" + DATA_PATH + "icon256.png\" -resize 16x16 \"" + DATA_PATH + "icon16.png\"" + " && convert \"" + DATA_PATH
			+ "icon256.png\" -resize 32x32 \"" + DATA_PATH + "icon32.png\"" + " && convert \"" + DATA_PATH + "icon256.png\" -resize 64x64 \"" + DATA_PATH
			+ "icon64.png\"" + " && convert \"" + DATA_PATH + "icon256.png\" -resize 128x128 \"" + DATA_PATH + "icon128.png\"" + " && convert \"" + DATA_PATH
			+ "icon256.png\" \"" + DATA_PATH + "icon32.png\" \"" + DATA_PATH + "icon64.png\" \"" + DATA_PATH + "icon128.png\" \"" + DATA_PATH
			+ "icon256.png\" -colors 16777216 ";
	...
	public static void recalculatePaths() {
		...
		CONVERT_COMMAND = " -gravity center -resize 256x256 -extent 256x256 -transparent white -colors 16777216 \"" + DATA_PATH + "icon256.png\""
				+ " && composite -gravity SouthEast foldericon.png \"" + DATA_PATH + "icon256.png\" \"" + DATA_PATH + "icon256.png\"" + " && convert \""
				+ DATA_PATH + "icon256.png\" -resize 16x16 \"" + DATA_PATH + "icon16.png\"" + " && convert \"" + DATA_PATH + "icon256.png\" -resize 32x32 \""
				+ DATA_PATH + "icon32.png\"" + " && convert \"" + DATA_PATH + "icon256.png\" -resize 64x64 \"" + DATA_PATH + "icon64.png\"" + " && convert \""
				+ DATA_PATH + "icon256.png\" -resize 128x128 \"" + DATA_PATH + "icon128.png\"" + " && convert \"" + DATA_PATH + "icon256.png\" \"" + DATA_PATH
				+ "icon32.png\" \"" + DATA_PATH + "icon64.png\" \"" + DATA_PATH + "icon128.png\" \"" + DATA_PATH + "icon256.png\" -colors 16777216 ";
